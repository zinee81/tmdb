            ...
            <div className={styles.wrapper}>
              ...
              <div className={styles.dt_info}>
                <div className={styles.title}>
                  <b>{state.movie.title}</b> ({state.movie.release_date.slice(0, 4)})
                </div>
                <div>
                  {state.movie.release_date} ({state.movie.origin_country[0]})ㆍ ㆍ{Math.floor(state.movie.runtime / 60)}h {state.movie.runtime % 60}m
                </div>
